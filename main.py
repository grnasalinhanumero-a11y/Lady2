...
# In TcPChaT function, update /status command:
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "hi"):
                            ...
                            header = f"[c][00FF00]Hey {player_name} [00FFFF]Welcome To MG24 GAMER's BOT"
...
async def MaiiiinE():
    ...
    try:
        ...
        region = getattr(MajoRLoGinauTh, 'region', 'BR')
